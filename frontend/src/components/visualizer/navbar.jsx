    ...
    render() {
        return (
            <div className="navbar" id="navbar">
                <button className='buttonVisualizer' id="random" onClick = {() => this.props.newList(1)}>Random</button>
                <Algorithms 
                ...
                />
                <button className='buttonVisualizer' id="start" onClick = {() => this.props.start()}>Start</button>
                <a 
                    className="icon" 
